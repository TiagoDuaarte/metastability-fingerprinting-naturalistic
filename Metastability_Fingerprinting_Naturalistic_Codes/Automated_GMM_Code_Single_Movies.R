...
# This code is set to a single movies file, following variables below:
#subjects, iself, iothers, metastablity and windows
...
# Define o diretório da pasta contendo os arquivos
setwd("~/Desktop/Filmes - Atlases/export/Gordon/Citizenfour/ORGANIZED_DATA/")
initial_path <- "~/Desktop/Filmes - Atlases/export/Gordon/Citizenfour/ORGANIZED_DATA/"
...
for (file in csv_files) {
  ...
  #This code assume that is only one movie in the data
  ...
  #Model
  model = glmer(iothers ~ meta + iself + window + (1|subject), data=movie_measures, family = Gamma(link=log))
